...
from typing import Optional, TextIO, Dict, Union
...
def gen_gradescope_output(
    ...
    """
    Generates JSON file that can be consumed by Gradescope's .
    ...
    """
    gradescope_json: Dict[str, Union[str, float]] = {}
...
def cmd(gradescope, base_dir):
    ...
    if gradescope is None:
        ...
        origin_upstream = GitRepoRemoteValidator(
            repo_dir,
            "upstream",
            "git@github.com:uchicago-cmsc14200-spr-2023/coursework-upstream.git",
            depends=[is_repo],
        )
