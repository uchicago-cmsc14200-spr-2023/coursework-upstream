    ...
    def _validate(self):
        ...
        with open(self._path) as f:
            ...
            if self._text in f_txt:
                self._valid = False
                self._error_msg = f"{self._filename} contains the text '{self._text}'"
            else:
                self._valid = True
        ...
        with open(self._path) as f:
            ...
            if self._exact:
                if f_txt.rstrip() != self._pattern:
                    self._error_msg = f"{self._filename} must contain exactly the following: '{self._pattern}'"
                    self._valid = False
            elif self._regex:
                ...
                if self._pattern not in f_txt:
                    self._error_msg = f"{self._filename} must contain the following: '{self._pattern}'"
                    self._valid = False
